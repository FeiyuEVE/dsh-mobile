...
import { addressAllowed, parseAuthority, parseCidr, RequestTrustPolicy, resolveAuthority, } from '../src/network.js';
...
describe('network trust policy', () => {
    ...
    it.each([
        ...
        const policy = new RequestTrustPolicy([parseAuthority('harness.example')], port, [parseCidr('10.0.0.0/8')], tls);
...
//# sourceMappingURL=config-network.test.js.map