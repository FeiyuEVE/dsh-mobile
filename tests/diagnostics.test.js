...
import { collectConnectionDiagnostics, remoteDiagnosticTimeoutMs } from '../src/diagnostics.js';
const healthy = {
...
describe('connection diagnostics', () => {
    ...
    it('emits stable reasons for off, login, connecting, and unreachable remote variants', async () => {
        const probe = { firewall: async () => ({ state: 'ready' }), remote: async () => ({ state: 'unreachable' }) };
